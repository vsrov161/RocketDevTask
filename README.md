...
> При первом входе Grafana может попросить сменить пароль. Для тестовых целей можно оставить старый или задать новый.
...
в самом конце этой странице необходимо нажать `Save & test`
